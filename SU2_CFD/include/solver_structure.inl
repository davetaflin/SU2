...
inline void CSolver::RegisterSolution(CGeometry *geometry_container, CConfig *config, unsigned long nPoint_coarse){}
...
inline void CSolver::ExtractAdjoint_Solution(CGeometry *geometry, CConfig *config, unsigned long nPoint_coarse){}
